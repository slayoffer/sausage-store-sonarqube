pipeline {
  ...
  stages {
      ...
      stage('Post to slack') {
          steps {
              sh 'curl -X POST -H "Content-type: application/json" --data \'{"text": "**Антон Евсеев** собрал приложение."}\' https://hooks.slack.com/services/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'
          }
      }
  }
}